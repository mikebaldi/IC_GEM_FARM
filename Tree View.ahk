...
objArray := [ new IdleGameManager, new BrivUnnaturalHasteHandler, new BrivSteelbonesHandler, new TimeScaleWhenNotAttackedhandler, new HavilarImpHandler, new OminContractualObligationsHandler, new NerdWagonHandler, new SentryEchoHandler, new HewMaanTeamworkHandler ]
