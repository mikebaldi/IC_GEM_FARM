...
class HavilarImpHandler extends ActiveEffectKeyHandler
{
    ...
    currentOtherImpIndex := new System.Int32(288, 432, this)
...
class TimeScaleWhenNotAttackedHandler extends ActiveEffectKeyHandler
{
    ...
    effectKey := new CrusadersGame.Effects.EffectKey(24, 48, this)
    scaleActive := new System.Boolean(216, 272, this)
    effectTime := new System.Double(224, 280, this)
    ;FE
}
...
class ActiveEffectKeyHandler extends System.Object
{
    __new()
    {
        ...
        this.ParentObj := new ActiveEffectKeyHandler_Parent(MemoryReader.InitHeroes(), this.ChampID, this.UpgradeID, this.EffectID, this)
        return this
    }
