...
class CrusadersGame
{
    ...
    class GameScreen
    {
        ...
        class Monster extends UnityGameEngine.Display.Drawable
        {
            ...
            monsterDef := new CrusadersGame.Defs.MonsterDef(572, 840, this)
    ...
    class LoadingScreen extends UnityGameEngine.GameScreenController.GameScreen
    {
        ...
        loadingText := new UnityGameEngine.Display.Drawable(584, 856, this)
        loadingProgress := new System.Int32(732, 1152, this)
        socialUserAuthenticationDone := new System.Boolean(757, 1177, this)
        loadUserReady := new System.Boolean(758, 1178, this)
        loadingGameUser := new System.Boolean(759, 1179, this)
        loadingDefinitions := new System.Boolean(763, 1183, this)
        loadingDefinitionsProgress := new System.Single(776, 1196, this)
        ;FE
    }
...
class UnityGameEngine
{
    ...
    class Display
    {
        class DrawableButton extends UnityGameEngine.Display.Drawable
        {
            ...
            toggled := new System.Boolean(638, 938, this)
            ;FE
        }
